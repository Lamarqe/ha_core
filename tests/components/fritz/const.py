...
MOCK_HOST_REPEATER = {
    "Index": 4,
    "IPAddress": MOCK_IPS["fritz-repeater"],
    "MACAddress": MOCK_MESH_SLAVE_MAC,
    "Active": True,
    ...
    "X_AVM-DE_UpdateSuccessful": "unknown",
    "X_AVM-DE_InfoURL": None,
    "X_AVM-DE_MACAddressList": f"{MOCK_MESH_SLAVE_MAC},{MOCK_MESH_SLAVE_WIFI1_MAC}",
    "X_AVM-DE_Model": None,
    "X_AVM-DE_URL": f"http://{MOCK_IPS['fritz-repeater']}",
    "X_AVM-DE_Guest": False,
    "X_AVM-DE_RequestClient": "0",
    "X_AVM-DE_VPN": False,
    "X_AVM-DE_WANAccess": "granted",
    ...
    "X_AVM-DE_IsMeshable": "1",
    "X_AVM-DE_Priority": "0",
    "X_AVM-DE_FriendlyName": "fritz-repeater",
    "X_AVM-DE_FriendlyNameIsWriteable": "0",
}
